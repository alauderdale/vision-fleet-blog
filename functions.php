...
function boiler_setup() {
	...
	register_nav_menus( array(
		...
		'footer_menu_one' => __( 'Footer Menu 1', 'boiler' ),
	) );
...
function boiler_scripts_styles() {
	...
	wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/vendor/modernizr.custom.js', '20120206', true );

	wp_enqueue_script( 'bootstrap-validator', get_template_directory_uri() . '/js/vendor/bootstrapValidator.min.js', '20120206', true );

	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/vendor/bootstrap.min.js', '20120206', true );
